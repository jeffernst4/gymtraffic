...
p1 +
  ...
  theme(axis.text = element_text(color = "#333333", size = 9)) +
  theme(axis.title = element_text(color = "#333333", face = "bold", size = 12)) +
  theme(plot.title = element_text(color = "#333333", face = "bold", size = 16))
...
p1 + geom_area(aes(y = number_people), color = "#AA4488", fill = "#AA4488", alpha = .3) +
